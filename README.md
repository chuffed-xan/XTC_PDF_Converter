This is a very simple browser-based XTC to PDF converter used to create PDFs from XTC files for the XTeink readers.

Instructions:
  - Download the xtc-to-pdf.html file and the pdf-lib.min.js file and save them in the same folder.
  - Open the xtc-to-pdf.html in browser and click "Browse..." to select your XTC File.
...
(This was created using ChatGPT and was based on this web-viewer for XTC files (https://github.com/SimoGecko/XtcViewer/). I cannot take credit for the coding of this tool as it was performed by ChatGPT and was based on the work of another programmer.)
